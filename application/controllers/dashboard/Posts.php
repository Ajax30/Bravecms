...
class Posts extends CI_Controller
{
    ...
    public function search()
    {
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            //load and configure pagination 
            $this->load->library('pagination');
            $config['base_url']             = base_url("/dashboard/posts/search");
            $config['query_string_segment'] = 'page';
    ...
    public function update()
    {
        ...
        $this->form_validation->set_rules('title', 'Title', 'required', array(
            'required' => 'The %s field can not be empty'
        ));
        $this->form_validation->set_rules('desc', 'Short description', 'required', array(
            'required' => 'The %s field can not be empty'
        ));
        $this->form_validation->set_rules('body', 'Body', 'required', array(
            'required' => 'The %s field can not be empty'
        ));
        $this->form_validation->set_error_delimiters('<p class="error-message">', '</p>');
